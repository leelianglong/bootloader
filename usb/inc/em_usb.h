...
} __attribute__ ((packed)) USB_CommonDescriptor_TypeDef;
EFM32_PACK_END()
...
} __attribute__ ((packed)) USB_BOSDescriptor_TypeDef;
EFM32_PACK_END()
...
} __attribute__ ((packed)) USB_SSDeviceCapabilityDescriptor_TypeDef;
EFM32_PACK_END()
...
} __attribute__ ((packed)) USB_DeviceCapabilityDescriptor_TypeDef;
EFM32_PACK_END()
...
} __attribute__ ((packed)) USB_SmartCardDescriptor_TypeDef;
EFM32_PACK_END()
/** @} (end addtogroup USB_COMMON) */
